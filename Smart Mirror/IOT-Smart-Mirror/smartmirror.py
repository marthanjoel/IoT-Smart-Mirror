...
weather_api_token = 'dcf444ffc51171526e2a7befe9a1aaad' # create account at https://darksky.net/dev/
weather_lang = 'en' # see https://darksky.net/dev/docs/forecast for full list of language parameters values
weather_unit = 'auto' # see https://darksky.net/dev/docs/forecast for full list of unit parameters values
latitude = '12.9339' # Set this if IP location lookup does not work for you (must be a string)
longitude = '77.6921' # Set this if IP location lookup does not work for you (must be a string)
xlarge_text_size = 94
large_text_size = 48
medium_text_size = 28
small_text_size = 18
    ...
    def get_weather(self):
        try:
            ...
            if latitude is None and longitude is None:
                ...
                location2 = "Bengaluru,KA"# get location
